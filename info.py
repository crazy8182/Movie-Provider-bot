...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb://mahesh81:mahesh81@<hostname>/?ssl=true&replicaSet=atlas-3d58cs-shard-0&authSource=admin&retryWrites=true&w=majority")
